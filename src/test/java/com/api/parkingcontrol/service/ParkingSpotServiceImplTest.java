...
class ParkingSpotServiceImplTest {
	...
	public void save_InsertParkingSpot_WhenSuccessful() {
		...
		ParkingSpotModel parkingSpot = parkingSpotServiceImpl.save(parkingSpotDto);
	...
	public void save_ThrowConstraintViolationException_WhenParkingSpotDtoHaveInvalidFields() {
		...
		assertThrows(ConstraintViolationException.class, () -> parkingSpotServiceImpl.save(parkingSpotDto));
	}
	...
	public void existsByLicensePlateCar_ReturnFalse_WhenLicensePlateCarNotIsInUse() {
		boolean existsByLicensePlateCar = parkingSpotServiceImpl.existsByLicensePlateCar("123");
	...
	public void existsByParkingSpotNumber_ReturnFalse_WhenParkingSpotNumberNotIsInUse() {
		boolean existsByParkingSpotNumber = parkingSpotServiceImpl.existsByParkingSpotNumber("123");
	...
	public void existsByApartmentAndBlock_ReturnFalse_WhenApartmentAndBlockNotIsInUse() {
		boolean existsByApartmentAndBlock = parkingSpotServiceImpl.existsByApartmentAndBlock("123", "456");
	...
	public void existsByApartment_ReturnFalse_WhenApartamentNotIsInUse() {
		boolean existsByApartment = parkingSpotServiceImpl.existsApartament("123");
	...
	public void findAll_ReturnListParkingSpotInsidePageObject_WhenSuccessful() {
		Page<ParkingSpotModel> findAll = parkingSpotServiceImpl.findAll(PageRequest.of(1, 1));
	...
	public void findByIdOrThrowsParkingSpotNotFoundException_ReturnParkingSpot_WhenSuccessful() {
		ParkingSpotModel parkingSpotFound = parkingSpotServiceImpl.
	...
	public void findByIdOrThrowsParkingSpotNotFoundException_ThrowParkingSpotNotFoundException_WhenParkingSpotNotFound() {
		...
		assertThrows(ParkingSpotNotFoundException.class, () -> parkingSpotServiceImpl
				.findByIdOrThrowsParkingSpotNotFoundException(UUID.randomUUID()));
	}
	...
	public void delete_RemoveParkingSpot_WhenSuccessful() {
		assertDoesNotThrow(() -> parkingSpotServiceImpl.delete(UUID.randomUUID()));
	}
	...
	public void delete_ThrowsParkingSpotNotFoundException_WhenParkingSpotNotFoundById() {
		...
		assertThrows(ParkingSpotNotFoundException.class, () -> parkingSpotServiceImpl.delete(UUID.randomUUID()));
	}
	...
	public void updated_ReplaceParkingSpot_WhenSuccessful() {
		...
		assertDoesNotThrow(() -> parkingSpotServiceImpl.updated(UUID.randomUUID(), parkingSpotPutDto));
	}
	...
	public void updated_ThrowsParkingSpotNotFoundException_WhenParkingSpotNotFoundById() {
		...
		assertThrows(ParkingSpotNotFoundException.class, () -> parkingSpotServiceImpl.updated(UUID.randomUUID(),
				parkingSpotPutDto));
	}
	...
	public void updated_ThrowConstraintViolationException_WhenParkingSpotDtoHaveInvalidFields() {
		...
		assertThrows(ConstraintViolationException.class, () -> parkingSpotServiceImpl.updated(UUID.randomUUID(),
				parkingSpotPutDto));
	}
